...
<html class="no-js" lang="en">
  <head>
    ...
    <title>Register || ELECTROBYTE</title>
      ...
      <div class="row">
        <div class="small-8">
          ...
          <div class="row">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="St.80 Highline" name="address">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="text" id="right-label" placeholder="USA" name="city">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
            ...
            <div class="small-8 columns">
              <input type="number" id="right-label" placeholder="10080" name="pin">
            </div>
          </div>
          <div class="row">
            <div class="small-4 columns">
